...
def controls_2(x,y):
    ...
    while True:
        ...
        pygame.display.flip()
        clock.tick(60)
        if user_text == "print(\'up\')" or user_text == "print(\'down\')" or user_text == "print(\'left\')" or user_text == "print(\'right\')":
            return user_text
  
def snake_update(first_snake, plants, snake_1,hori_p, verti_p, apple, pos_x, pos_y):
    if show_number == 0:
